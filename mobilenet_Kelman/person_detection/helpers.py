...
def draw_box_label(img, bbox_id, bbox_cv2, box_color= (0,0,255), show_label=True):
    '''
    ...
    #box_color= (0, 255, 255)
    #text_id= 'Id='+str(np.random.randint(1000))
    ...
    if show_label:
        ...
        text_id= 'Id='+str(bbox_id)
        cv2.putText(img,text_id,(right-110,top-50), font, font_size, font_color, 1, cv2.LINE_AA)
