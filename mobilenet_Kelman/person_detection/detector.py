'''
Implement and test person detection (localization)
'''
...
class PersonDetector(object):
    ...
    def get_localization(self, image, visual=False):  
        ...
        """Determines the locations of the person in the image
        ...
        with self.detection_graph.as_default():
              ...
              # The ID for person in COCO data set is 1 
              ...
              if len(idx_vec) ==0:
                  ...
                  for idx in idx_vec:
                      ...
                      if ((ratio < 4) and (ratio > 0.8) and (box_h>20) and (box_w>20)):
...
if __name__ == '__main__':
        ...
        while (1):
            ...
            start = time.time()
            b = det.get_localization(frame, visual=False)
            end = time.time()
